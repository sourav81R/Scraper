...
const AuthShowcase = ({ caption, title }) => (
  <div className="relative hidden overflow-hidden rounded-[34px] border border-white/10 bg-[#0f172a] px-7 py-6 text-white lg:flex lg:flex-col">
    ...
    <div className="relative z-10">
      ...
      <h2 className="mt-3 max-w-lg text-[2.3rem] font-semibold leading-tight">
        {title}
      </h2>
      ...
      <div className="mt-5 space-y-3">
        {authHighlights.map((highlight, index) => (
          <motion.div
            ...
            className="rounded-[22px] border border-white/10 bg-white/5 p-3 backdrop-blur-xl"
