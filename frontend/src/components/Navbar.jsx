  ...
  return (
    <>
      <header className="sticky top-0 z-50 px-3 pt-3 sm:px-4 sm:pt-4">
        <div className="navbar-shell relative mx-auto w-full max-w-[96rem] overflow-visible">
          <div className="glass-panel flex items-center justify-between gap-4 overflow-visible rounded-[30px] border border-[var(--premium-border)] px-4 py-4 shadow-[0_22px_60px_rgba(15,23,42,0.12)] sm:px-6 lg:px-8">
                  ...
                  <AnimatePresence>
                    {profileOpen ? (
                      <motion.div
                        ...
                        className="glass-panel absolute right-0 top-[calc(100%+0.9rem)] z-[80] hidden w-64 rounded-[24px] border border-[var(--premium-border)] p-3 shadow-[0_28px_64px_rgba(15,23,42,0.18)] lg:block"
        ...
        <AnimatePresence>
          {mobileOpen ? (
            <motion.div
              ...
              className="mx-auto mt-3 w-full max-w-[96rem] overflow-hidden rounded-[28px] border border-[var(--premium-border)] bg-[var(--page-veil)]/96 px-4 pb-5 pt-4 shadow-[0_24px_60px_rgba(15,23,42,0.12)] backdrop-blur-2xl lg:hidden"
